...
static const struct audio_ao_dev_op dev_ops_ao_line_out_i2stx[] =
{
...
static const struct audio_ao_dev_info dev_infos_ao_lineout_i2stx[] =
{
    {
    .dma        = AUD_DMA_READER1,
    .i2s_if     = AUD_I2S_IF_CODEC_TX,
...
static const struct audio_ao_dev audio_ao_devs[] =
{
    ...
    {
        .id = AUD_AO_DEV_LINEOUT_I2STX,
        .info = dev_infos_ao_lineout_i2stx,
        .op = dev_ops_ao_line_out_i2stx,
    },
};
