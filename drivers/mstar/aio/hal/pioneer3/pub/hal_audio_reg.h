...
enum
{
    ...
    BACH_MMCDEC2_DPGA_CFG1 = 0x64,
    BACH_MMCDEC2_DPGA_CFG2 = 0x66,
    BACH_HD_SDM_OFFSET     = 0xCE,
    BACH_HD_SDM_CTRL_0     = 0xD0,
    BACH_HD_SDM_CTRL_1     = 0xD2
};
...
enum
{
    ...
    BACH_EN_CTRL_AU2       =  0xC8,
    BACH_SR0_SEL_AU2       =  0xCA,
    BACH_MUX4_SEL          =  0xCC,
    BACH_DMA_TEST_CTRL5    =  0xEA,
    BACH_DMA_TEST_CTRL6    =  0xEC,
    BACH_DMA_TEST_CTRL7    =  0xEE,
    BACH_AU2HDMI_CTRL      =  0xF0,
    BACH_AU2HDMI_REF_FS    =  0xF2
};
...
enum
{
    ...
    BACH_ANALOG_CTRL0a     =  0x14,
    BACH_ANALOG_CTRL0b     =  0x16,
    BACH_ANALOG_CTRL0c     =  0x18,
    BACH_ANALOG_CTRL0d     =  0x1A,
 ...
 * @brief Register CE
 */
#define HD_SDM_OFFSET_MSK            0xffff

/**
 * @brief Register D0
 */
#define REG_HD_SDM_OFFSET_POS        14
#define REG_HD_SDM_OFFSET_MSK        (0x3 << REG_HD_SDM_OFFSET_POS)
#define REG_HD_SDM_TEST_EN           (1 << 12)
#define REG_HD_SDM_SFT_DIS           (1 << 11)
#define REG_HD_DAC_TEST_EN           (1 << 10)
#define REG_HD_FIX_MSB_EN            (1 << 9)
#define REG_HD_FIX_MSB_SEL_POS       4
#define REG_HD_FIX_MSB_SEL_MSK       (0x1f << REG_HD_FIX_MSB_SEL_POS)
#define REG_HD_DITHER_EN             (1 << 3)
#define REG_HD_DITHER_SEL_POS        3
#define REG_HD_DITHER_SEL_MSK        (0x7 << REG_HD_DITHER_SEL_POS)

/**
 * @brief Register D2
 */
#define REG_HD_SDM_DINL_SEL_POS      13
#define REG_HD_SDM_DINL_SEL_MSK      (0x7 << REG_HD_SDM_DINL_SEL_POS)
#define REG_HD_SDM_DINL_INV          (1 << 12)
#define REG_HD_DWA_LEVEL_POS         4
#define REG_HD_DWA_LEVEL_POS_MSK     (0x3 << REG_HD_DWA_LEVEL_POS)
#define REG_HD_SDM_LEVEL_POS         2
#define REG_HD_SDM_LEVEL_POS_MSK     (0x3 << REG_HD_SDM_LEVEL_POS)
#define REG_HD_FIRST_ORDER_EN        (1 << 1)
#define REG_HD_SDM_EN                (1 << 0)
 ...
 * @brief Register 04h
 */
#define REG_EN_SW_MIC2_R_POS          10
#define REG_EN_SW_MIC2_R_MSK          (0x3<<REG_EN_SW_MIC2_R_POS)
#define REG_EN_SW_MIC2_L_POS          14
#define REG_EN_SW_MIC2_L_MSK          (0x3<<REG_EN_SW_MIC2_L_POS)
...
#define REG_PD_HD                     (1<<14)
#define REG_PD_HD_BIAS                (1<<15)
...
#define REG_SEL_GAIN_INMUX2_POS       10
#define REG_SEL_GAIN_INMUX2_MSK       (0x7<<REG_SEL_GAIN_INMUX2_POS)
#define REG_SEL_GAIN_INMUX3_POS       13
#define REG_SEL_GAIN_INMUX3_MSK       (0x7<<REG_SEL_GAIN_INMUX3_POS)
...
#define REG_SEL_IBIAS_INMUX2_POS      6
#define REG_SEL_IBIAS_INMUX2_MSK      (0x3<<REG_SEL_IBIAS_INMUX2_POS)
#define REG_SEL_IBIAS_INMUX_POS       8
#define REG_SEL_IBIAS_INMUX_MSK       (0x3<<REG_SEL_IBIAS_INMUX_POS)
#define REG_SEL_IBIAS_ADC1_POS        10
#define REG_SEL_IBIAS_ADC1_MSK        (0x1F<<REG_SEL_IBIAS_ADC1_POS)
...
#define REG_SEL_MICGAIN_STG1_L_EXT_POS  12
#define REG_SEL_MICGAIN_STG1_L_EXT_MSK  (0x1<<REG_SEL_MICGAIN_STG1_L_EXT_POS)
#define REG_SEL_MICGAIN_STG1_R_EXT_POS  13
#define REG_SEL_MICGAIN_STG1_R_EXT_MSK  (0x1<<REG_SEL_MICGAIN_STG1_R_EXT_POS)

/**
 * @brief Register 12h
 */
#define REG_EN_BYP_INMUX2_POS         0
#define REG_EN_BYP_INMUX2_MSK         (0x3<<REG_EN_BYP_INMUX2_POS)
#define REG_EN_CHOP_ADC1              (1<<2)
#define REG_EN_DIT_ADC1               (1<<9)

/**
 * @brief Register 14h
 */
#define REG_EN_MUTE_INMUX2_POS        0
#define REG_EN_MUTE_INMUX2_MSK        (0x3<<REG_EN_MUTE_INMUX2_POS)
#define REG_EN_MUTE_MIC_STG2_L        (1<<2)
#define REG_EN_MUTE_MIC_STG2_R        (1<<3)
#define REG_EN_QS_LDO_ADC1            (1<<4)
#define REG_EN_SHRT_L_ADC1            (1<<6)
#define REG_EN_SHRT_R_ADC1            (1<<7)
#define REG_EN_TST_IBIAS_ADC1_POS     8
#define REG_EN_TST_IBIAS_ADC1_MSK     (0x3<<REG_EN_TST_IBIAS_ADC1_POS)

/**
 * @brief Register 16h
 */
#define REG_PD_ADC1                   (1<<0)
#define REG_PD_INMUX2_POS             2
#define REG_PD_INMUX2_MSK             (0x3<<REG_PD_INMUX2_POS)
#define REG_PD_LDO_ADC1               (1<<5)
#define REG_PD_MIC_STG2_L             (1<<7)
#define REG_PD_MIC_STG2_R             (1<<8)

/**
 * @brief Register 18h
 */
#define REG_SEL_CH_INMUX2_POS         0
#define REG_SEL_CH_INMUX2_MSK         (0xF<<REG_SEL_CH_INMUX2_POS)
#define REG_SEL_CH_INMUX3_POS         4
#define REG_SEL_CH_INMUX3_MSK         (0xF<<REG_SEL_CH_INMUX3_POS)
#define REG_SEL_CHOP_ADC1             (1<<10)
#define REG_SEL_CHOP_PHASE_ADC1       (1<<11)
#define REG_SEL_CK_PHASE_ADC1         (1<<14)
#define REG_SEL_DIT_LVL_ADC1          (1<<15)

/**
 * @brief Register 1Ah
 */
#define REG_SEL_MICGAIN_INMUX2_POS      0
#define REG_SEL_MICGAIN_INMUX2_MSK      (0x3<<REG_SEL_MICGAIN_INMUX2_POS)
#define REG_SEL_MICGAIN_STG2_L_POS      2
#define REG_SEL_MICGAIN_STG2_L_MSK      (0x3<<REG_SEL_MICGAIN_STG2_L_POS)
#define REG_SEL_MICGAIN_STG2_R_POS      4
#define REG_SEL_MICGAIN_STG2_R_MSK      (0x3<<REG_SEL_MICGAIN_STG2_R_POS)
#define REG_SEL_MICGAIN_STG2_L_EXT_POS  12
#define REG_SEL_MICGAIN_STG2_L_EXT_MSK  (0x1<<REG_SEL_MICGAIN_STG2_L_EXT_POS)
#define REG_SEL_MICGAIN_STG2_R_EXT_POS  13
#define REG_SEL_MICGAIN_STG2_R_EXT_MSK  (0x1<<REG_SEL_MICGAIN_STG2_R_EXT_POS)
