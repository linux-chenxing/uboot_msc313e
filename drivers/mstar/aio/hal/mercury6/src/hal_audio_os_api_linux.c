...
BOOL HalAudOsApiPreSetAllPadmux(void)
{
    ...
    switch(nMode)
    {
        ...
        case PINMUX_FOR_I2S_TX_MODE_6:
            nPadMuxMode = 6;
            break;
        case PINMUX_FOR_I2S_TX_MODE_7:
            nPadMuxMode = 7;
            break;
        case PINMUX_FOR_I2S_TX_MODE_8:
            nPadMuxMode = 8;
            break;
        case PINMUX_FOR_I2S_TX_MODE_9:
            nPadMuxMode = 9;
            break;
        case PINMUX_FOR_I2S_TX_MODE_10:
            nPadMuxMode = 10;
            break;
        default:
            nPadMuxMode = 0;
    ...
    switch(nMode)
    {
        ...
        case PINMUX_FOR_I2S_RX_MODE_6:
            nPadMuxMode = 6;
            break;
        case PINMUX_FOR_I2S_RX_MODE_7:
            nPadMuxMode = 7;
            break;
        case PINMUX_FOR_I2S_RX_MODE_8:
            nPadMuxMode = 8;
            break;
        case PINMUX_FOR_I2S_RX_MODE_9:
            nPadMuxMode = 9;
            break;
        case PINMUX_FOR_I2S_RX_MODE_10:
            nPadMuxMode = 10;
            break;
        case PINMUX_FOR_I2S_RX_MODE_11:
            nPadMuxMode = 11;
            break;
        default:
            nPadMuxMode = 0;
    ...
    switch(nMode)
    {
        case PINMUX_FOR_DMIC_4CH_MODE_1:
            nPadMuxMode = 1;
            break;
        case PINMUX_FOR_DMIC_4CH_MODE_2:
            nPadMuxMode = 2;
            break;
        case PINMUX_FOR_DMIC_4CH_MODE_3:
            nPadMuxMode = 3;
            break;
        case PINMUX_FOR_DMIC_4CH_MODE_4:
            nPadMuxMode = 4;
            break;
        case PINMUX_FOR_DMIC_4CH_MODE_5:
            nPadMuxMode = 5;
            break;
        case PINMUX_FOR_DMIC_4CH_MODE_6:
            nPadMuxMode = 6;
            break;
        case PINMUX_FOR_DMIC_4CH_MODE_7:
            nPadMuxMode = 7;
            break;
        case PINMUX_FOR_DMIC_4CH_MODE_8:
            nPadMuxMode = 8;
            break;
        case PINMUX_FOR_DMIC_4CH_MODE_9:
            nPadMuxMode = 9;
            break;
        case PINMUX_FOR_DMIC_4CH_MODE_10:
            nPadMuxMode = 10;
            break;
        default:
            nPadMuxMode = 0;
    ...
    switch(nMode)
    {
        ...
        case PINMUX_FOR_I2S_RXTX_MODE_6:
            nPadMuxMode = 6;
            break;
        case PINMUX_FOR_I2S_RXTX_MODE_7:
            nPadMuxMode = 7;
            break;
        default:
            nPadMuxMode = 0;
