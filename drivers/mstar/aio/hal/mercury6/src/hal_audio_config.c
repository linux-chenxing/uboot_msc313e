...
static const int mux_list_for_config_pcm_ai_adc_4ch[][2] =
{
    { AUD_MUX_DMAWR1, 1 },
    { AUD_MUX_DMAWR2_MCH, 1 }
};
...
static const int dpga_list_ai_adc_4ch[] =
{
    AUD_DPGA_ADC,
    AUD_DPGA_AEC1,
    AUD_DPGA_DEC2
...
static const int mch_sel_ai_adc_2[AUD_MCH_CH_BIND_NUM] =
{
    AUD_MCH_SEL_AMIC01,
    AUD_MCH_SEL_AMIC23,
    AUD_MCH_SEL_SRC,
...
static const struct audio_mch_bind mch_bind_ai_adc_4ch[] =
{
    // when ch = 4 -> mch_ch_num = 8, ch01:AMIC ch23:AMIC ch45:SRC ch67:X
    {
        .para_dma_ch = 4,
        .num_mch_ch = 8,
        .mch_sel = mch_sel_ai_adc_2,
    },
};
...
static const struct audio_info_mch info_mch_ai_adc_4ch[] =
{
    {
    .mch_set = AUD_MCH_SET_W2,
    .mch_bind = mch_bind_ai_adc_4ch,
    .num_mch_bind = AUD_ARRAY_SIZE(mch_bind_ai_adc_4ch),
    .mch_clk_ref = AUD_MCH_CLK_REF_ADC,
    },
};
...
static const struct audio_ai_dev_info dev_infos_ai_mic_4ch[] =
{
    {
    .dma        = AUD_DMA_WRITER2,
    .i2s_if     = AUD_I2S_IF_NULL,
    ...
    .use_tdm    = FALSE,
    .use_atop   = TRUE,
    .mux_list_for_config_pcm = mux_list_for_config_pcm_ai_adc_4ch,
    .num_mux_config_pcm = AUD_ARRAY_SIZE(mux_list_for_config_pcm_ai_adc_4ch),
    .mux_list_for_config_i2s = NULL,
    .num_mux_config_i2s = 0,
    .dpga_list  = dpga_list_ai_adc_4ch,
    .num_dpga   = AUD_ARRAY_SIZE(dpga_list_ai_adc_4ch),

    /* Mch */
    .use_mch = TRUE,
    .info_mch = info_mch_ai_adc_4ch,
...
static const struct audio_ai_dev audio_ai_devs[] =
{
    ...
    {
        .id = AUD_AI_DEV_AMIC_4CH,
        .info = dev_infos_ai_mic_4ch,
        .op = dev_ops_ai_adc,
    },
};
