...
typedef enum
{
    AUD_I2S_CLK_REF_DMIC,
    AUD_I2S_CLK_REF_ADC,
    AUD_I2S_CLK_REF_I2S_TDM_RX,
    AUD_I2S_CLK_REF_SRC,
    AUD_I2S_CLK_REF_NUM,
    AUD_I2S_CLK_REF_NULL = 0xff,
} AudI2sClkRef_e;
...
typedef enum
{
    ...
    AUD_PAD_MUX_I2S_RX,
    AUD_PAD_MUX_I2S_MCK,
    AUD_PAD_MUX_I2S_TXRX,
    AUD_PAD_MUX_I2S_MODE,
    AUD_PAD_MUX_NUM,
