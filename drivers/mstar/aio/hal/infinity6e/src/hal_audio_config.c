...
{
    {
        ...
        .fp = HalAudPriSetPadMuxI2sTXRX,
    },

	{
        .str = "i2s-tx-padmux",
        .fp = HalAudPriSetPadMuxI2sTX,
    },

    {
        .str = "i2s-rx-padmux",
        .fp = HalAudPriSetPadMuxI2sRX,
    },
...
static const struct audio_dts audio_dts_cfg[] =
{
    ...
    .audio_dts_keep_adc_power_on = "keep_adc_power_on",
    .audio_dts_keep_dac_power_on = "keep_dac_power_on",
    }
};
...
{
    { AUD_MUX_I2STDM_RX, 1 }, //diff from I6
};
...
static const int mch_sel_ai_dmic[AUD_MCH_CH_BIND_NUM] =
{
    AUD_MCH_SEL_ADC,
    AUD_MCH_SEL_SRC,
    AUD_MCH_SEL_NULL,
...
static const int mch_sel_ai_i2s_rx_4ch[AUD_MCH_CH_BIND_NUM] =
{
    AUD_MCH_SEL_I2S_RX,
    AUD_MCH_SEL_I2S_RX,
    AUD_MCH_SEL_NULL,
...
static const int mch_sel_ai_i2s_rx_8ch[AUD_MCH_CH_BIND_NUM] =
{
    AUD_MCH_SEL_I2S_RX,
    AUD_MCH_SEL_I2S_RX,
    AUD_MCH_SEL_I2S_RX,
...
static const int mch_sel_ai_i2s_rx_6ch[AUD_MCH_CH_BIND_NUM] =
{
    AUD_MCH_SEL_I2S_RX,
    AUD_MCH_SEL_NULL,
    AUD_MCH_SEL_I2S_RX,
...
{
    // when ch = 2 -> mch_ch_num = 2, ch01:i2s_rx ch23:SRC ch4567: X
    {
        .para_dma_ch = 2,
        .num_mch_ch = 2,
        .mch_sel = mch_sel_ai_i2s_rx,
    },
	// when ch = 4 -> mch_ch_num = 4, ch01:i2s_rx ch23:i2s_rx ch4567: X
    {
        .para_dma_ch = 4,
        .num_mch_ch = 4,
        .mch_sel = mch_sel_ai_i2s_rx_4ch,
    },
	// when ch = 8 -> mch_ch_num = 8, ch01:i2s_rx ch23:i2s_rx ch4567: i2s_rx
    {
        .para_dma_ch = 8,
        .num_mch_ch = 8,
        .mch_sel = mch_sel_ai_i2s_rx_8ch,
    },
	// when ch = 6 -> mch_ch_num = 6, ch01:i2s_rx ch23:X ch4567: i2s_rx
    {
        .para_dma_ch = 6,
        .num_mch_ch = 6,
        .mch_sel = mch_sel_ai_i2s_rx_6ch,
    },
};
...
static const struct audio_ai_dev_info dev_infos_ai_dmic[] =
{
    ...
    .mux_list_for_config_i2s = NULL,
    .num_mux_config_i2s = 0,
    .dpga_list  = dpga_list_ai_dmic,
    .num_dpga   = AUD_ARRAY_SIZE(dpga_list_ai_dmic),
