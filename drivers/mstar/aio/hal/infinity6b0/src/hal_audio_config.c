...
static const int mch_sel_ai_i2s_rx_src[AUD_MCH_CH_BIND_NUM] =
{
    AUD_MCH_SEL_I2S_RX,
    AUD_MCH_SEL_SRC,
    AUD_MCH_SEL_NULL,
...
static const struct audio_mch_bind mch_bind_ai_i2s_rx_src[] =
{
    // when ch = 2 -> mch_ch_num = 2, ch01:i2s_rx ch23:X ch4567: X
    {
        .para_dma_ch = 2,
        .num_mch_ch = 4,
        .mch_sel = mch_sel_ai_i2s_rx_src,
    },
};
...
static const struct audio_info_mch info_mch_ai_i2s_rx_src[] =
{
    {
    .mch_set = AUD_MCH_SET_W1,
    .mch_bind = mch_bind_ai_i2s_rx_src,
    .num_mch_bind = AUD_ARRAY_SIZE(mch_bind_ai_i2s_rx_src),
    .mch_clk_ref = AUD_MCH_CLK_REF_ADC,
    },
};
...
static const struct audio_ai_dev_info dev_infos_ai_i2s_rx_src[] =
{
    {
    .dma        = AUD_DMA_WRITER1,
    .i2s_if     = AUD_I2S_IF_CODEC_RX,
    ...
    /* Mch */
    .use_mch = TRUE,
    .info_mch = info_mch_ai_i2s_rx_src,
...
static const struct audio_ai_dev audio_ai_devs[] =
{
    ...
    {
        .id = AUD_AI_DEV_I2S_RX_SRC,
        .info = dev_infos_ai_i2s_rx_src,
        .op = dev_ops_ai_i2s_rx,
    },
};
