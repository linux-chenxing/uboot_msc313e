...
#define REG_DMA2_RD_EMPTY_TH_POS      8
#define REG_DMA2_RD_EMPTY_TH_MSK      (0XF << REG_DMA2_RD_EMPTY_TH_POS)
#define REG_DMA1_RD_EMPTY_TH_POS      4
#define REG_DMA1_RD_EMPTY_TH_MSK      (0XF << REG_DMA1_RD_EMPTY_TH_POS)
#define REG_DMA2_RD_WR_ENABLE         (1 << 1)
#define REG_DMA1_RD_WR_ENABLE         (1 << 0)
