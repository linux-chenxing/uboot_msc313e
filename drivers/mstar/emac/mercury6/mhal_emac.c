...
void MHal_EMAC_write_phy (unsigned char phy_addr, unsigned char address, u32 value)
{
    ...
    {
        uRegVal =  ( EMAC_HIGH | EMAC_CODE_802_3 | EMAC_RW_W)
        | (( phy_addr & 0x1F ) << PHY_ADDR_OFFSET ) | ( address << PHY_REGADDR_OFFSET ) | (value & 0xFFFF);
    }
...
void MHal_EMAC_Power_On_Clk(void)
{
    ...
    else
    {
        // pad mux
        {
            ...
            //MDrv_GPIO_PadGroupMode_Set(PINMUX_FOR_ETH1_MODE_4);
            MDrv_GPIO_PadVal_Set(PAD_TTL18, PINMUX_FOR_ETH1_MODE_4);
            MDrv_GPIO_PadVal_Set(PAD_TTL19, PINMUX_FOR_ETH1_MODE_4);
            MDrv_GPIO_PadVal_Set(PAD_TTL20, PINMUX_FOR_ETH1_MODE_4);
            MDrv_GPIO_PadVal_Set(PAD_TTL21, PINMUX_FOR_ETH1_MODE_4);
            MDrv_GPIO_PadVal_Set(PAD_TTL22, PINMUX_FOR_ETH1_MODE_4);
            MDrv_GPIO_PadVal_Set(PAD_TTL23, PINMUX_FOR_ETH1_MODE_4);
            MDrv_GPIO_PadVal_Set(PAD_TTL24, PINMUX_FOR_ETH1_MODE_4);
            MDrv_GPIO_PadVal_Set(PAD_TTL25, PINMUX_FOR_ETH1_MODE_4);
            MDrv_GPIO_PadVal_Set(PAD_TTL26, PINMUX_FOR_ETH1_MODE_4);
    #else
...
void MHal_EMAC_PHYHW_reset(void)
{
    ...
    MDrv_GPIO_Pad_Oen(PAD_TTL27);
    MDrv_GPIO_Pull_High(PAD_TTL27);
    mdelay(1);
    MDrv_GPIO_Pull_Low(PAD_TTL27);
    mdelay(1);
    MDrv_GPIO_Pull_High(PAD_TTL27);
    mdelay(1);
}
