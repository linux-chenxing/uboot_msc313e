...
INTERFACE void    DrvHdmitxOsMsDelay(MS_U32 u32Msec);
INTERFACE void    DrvHdmitxOsUsDelay(MS_U32 u32Usec);
...
INTERFACE MS_BOOL DrvHdmitxOsSetClkOff(void *pClkRate, MS_U32 u32ClkRateSize);
...
INTERFACE void    DrvHdmitxOsSetDebugEnable(MS_BOOL bEn);
#undef INTERFACE
