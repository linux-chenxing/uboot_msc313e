...
//  Macro and Define
//-------------------------------------------------------------------------------------------------
#define HDMITX_DTOP_BASE                (0x145900U)
#define HDMITX_ATOP_BASE                (0x145A00U)
#define HDMITX_DISP_GP_CTRL_BASE        (0x113700U)
...
#define REG_HDMITX_CLK_DISP_432         (0x48U)
#define REG_HDMITX_CLK_DISP_216         (0x48U)
