...
U32 eMMC_CMD8_MIU(U8 *pu8_DataBuf)
{
    ...
    REG_FCIE_W(FCIE_MIU_DMA_ADDR_15_0, (u32_dma_addr - 0x20000000) & 0xFFFF);
    REG_FCIE_W(FCIE_MIU_DMA_ADDR_31_16, (u32_dma_addr - 0x20000000) >> 16);
...
U32 eMMC_CMD17_MIU(U32 u32_eMMCBlkAddr, U8 *pu8_DataBuf)
{
    ...
    REG_FCIE_W(FCIE_MIU_DMA_ADDR_15_0, u32_dma_addr & 0xFFFF);
    REG_FCIE_W(FCIE_MIU_DMA_ADDR_31_16, (u32_dma_addr >> 16) & 0x0FFF);
