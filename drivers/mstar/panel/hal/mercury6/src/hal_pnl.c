...
{
    W2BYTEMSK(REG_PADTOP_6C_L, u16Val, 0x0fff);
}
...
void HalPnlSetFrameColorEn(bool bEn, void *pCtx)
{
    ...
    {
        W2BYTEMSK(REG_DISP_TOP_OP2_0_1C_L, bEn ? 0x8000 : 0x0000, 0x8000);
    }
}
...
void HalPnlSetFrameColor(u8 u16R, u16 u16G, u16 u16B, void *pCtx)
{
    ...
    if( _HalPnlGetRegByCtx(pCtx, &u32Reg, REG_DISP_TOP_OP2_0_21_L, REG_DISP_TOP_OP2_1_21_L) )
    {
        u16Val = (u16B & 0xFF) | (u16)(u16G & 0xFF) << 8;
        W2BYTEMSK(u32Reg, u16Val, 0xFFFF);
    }

    if( _HalPnlGetRegByCtx(pCtx, &u32Reg, REG_DISP_TOP_OP2_0_22_L, REG_DISP_TOP_OP2_1_22_L) )
    {
        u16Val = u16R & 0xFF;
...
{
    u32 u32Reg = 0;
    if( _HalPnlGetRegByCtx(pCtx, &u32Reg, REG_DISP_TOP_OP2_1_10_L, REG_DISP_TOP_OP2_1_10_L) )
    {
...
void HalPnlSetRgbSwap(HalPnlRgbSwapType_e enChR, HalPnlRgbSwapType_e enChG, HalPnlRgbSwapType_e enChB, void *pCtx)
{
    ...
    u16R = enChR == E_HAL_PNL_RGB_SWAP_B ? 0x01 << 4 :
           ...
           enChR == E_HAL_PNL_RGB_SWAP_R ? 0x03 << 4 :
                                           0x00;
    if( _HalPnlGetRegByCtx(pCtx, &u32Reg, REG_DISP_TOP_OP2_0_7E_L, REG_DISP_TOP_OP2_0_7E_L) )
    {
