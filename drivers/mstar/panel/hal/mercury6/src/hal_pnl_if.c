...
void __HalPnlIfSetPadMux(HalPnlLinkType_e eLinkType)
{
    switch (eLinkType)
    {
        case E_HAL_PNL_LINK_TTL:
            HalPnlSetTTLPadMux(1);
            break;
        case E_HAL_PNL_LINK_BT656:
            HalPnlSetBTPadMux(eLinkType, 1);
            break;
        case E_HAL_PNL_LINK_BT601:
            HalPnlSetBTPadMux(eLinkType, 1);
            break;
        case E_HAL_PNL_LINK_BT1120:
            HalPnlSetBTPadMux(eLinkType, 2);
            break;
        default:
            break;
    }
...
void __HalPnlIfSetUnifiedPrototypeConfig(DrvPnlCtxConfig_t *pPnlCtx)
{
    ...
    HalPnlRgbDataType_e eRgbDtype = pPnlCtx->pstHalUnfdCtx->stHalPnlUdParamCfg.eRgbDtype;

    if(eLinkType == E_HAL_PNL_LINK_TTL)
    {
        HalPnlSetLcdDisp1Used(1);
        HalPnlSetLcdDisp1Type(2);
        HalPnlSetLcdRgbDtype(eRgbDtype); //0x0
        HalPnlSetLcdBtEncMode(0);
        HalPnlSetLcdBtEncModeEn(0);
        HalPnlSetLcdBt601En(0);
        HalPnlSetLcdRgbEn(1);
    ...
    {
        eRgbDtype = 0x20 | ((eRgbDtype & 0x70) >> 4);
        HalPnlSetLcdDisp1Used(1);
        HalPnlSetLcdDisp1Type(2);
        HalPnlSetLcdRgbDtype(eRgbDtype); //0x24
        HalPnlSetLcdBtEncMode(0);
        HalPnlSetLcdBtEncModeEn(0);
        HalPnlSetLcdBt601En(1);
        HalPnlSetLcdRgbEn(1);
    ...
    else if(eLinkType == E_HAL_PNL_LINK_BT656)
    {
        ...
        HalPnlSetLcdDisp1Used(1);
        HalPnlSetLcdDisp1Type(2);
        HalPnlSetLcdRgbDtype(eRgbDtype); //0x21
        HalPnlSetLcdBtEncMode(0);
        HalPnlSetLcdBtClip(1);
        HalPnlSetLcdBtEncModeEn(1);
        HalPnlSetLcdBt601En(0);
    ...
    {
        eRgbDtype = 0x10 | ((eRgbDtype & 0x70) >> 4);
        HalPnlSetLcdDisp1Used(1);
        HalPnlSetLcdDisp1Type(2);
        HalPnlSetLcdRgbDtype(eRgbDtype); // 0x11
        HalPnlSetLcdBtEncMode(1);
        HalPnlSetLcdBtClip(1);
        HalPnlSetLcdBtEncModeEn(1);
        HalPnlSetLcdBt601En(0);
    ...
    else if(eLinkType == E_HAL_PNL_LINK_MCU_TYPE)
    {
        HalPnlSetLcdDisp1Used(1);
        HalPnlSetLcdDisp1Type(0); //(i80) Parallel panel
        HalPnlSetDsiGateEn(1);
        HalPnlSetLcdMiscDacMux(1);
    }
...
void __HalPnlIfSetUnifiedMipiDsiParamConfig(DrvPnlCtxConfig_t  *pPnlCtxCfg, HalPnlMipiDsiConfig_t *pstMipiDsiCfg)
{
    ...
    au8PolCh[0] = pstMipiDsiCfg->u8PolCh0;
    au8PolCh[1] = pstMipiDsiCfg->u8PolCh1;
    au8PolCh[2] = pstMipiDsiCfg->u8PolCh2;
    au8PolCh[3] = pstMipiDsiCfg->u8PolCh3;
    au8PolCh[4] = pstMipiDsiCfg->u8PolCh4;
    ...
    */
    ...
    //HalPnlSetClkScPixel(1, u32Dclk); ToDo CLK
    HalPnlSetTgenExtHsEn(1, (void *)pPnlCtxCfg); //ext_Hsync_En;

    HalPnlSetLpllSkew(pstMipiDsiCfg->u16DataClkSkew ? pstMipiDsiCfg->u16DataClkSkew : 7);

    //HalPnlSetDispToDsiMd(1, (void *)pPnlCtxCfg); // reg_hdmi_dsi = dsi
...
void _HalPnlIfSetParamConfig(void *pCtx, void *pCfg)
{
    ...
    if(DrvPnlOsPadMuxActive() == 0)
    {
        __HalPnlIfSetPadMux(pstParamCfg->eLinkType);
    }

    __HalPnlIfSetTimeGenConfig((DrvPnlCtxConfig_t *)pCtx, &pPnlCtxCfg->pstHalCtx->stTimingCfg);
    __HalPnlIfSetPrototypeConfig((DrvPnlCtxConfig_t *)pCtx);
...
{
    HalPnlQueryRet_e enRet = E_HAL_PNL_QUERY_RET_OK;
    HalPnlClkConfig_t *pstClkCfg = NULL;
    u8 au8ClkName[HAL_PNL_CLK_NUM][20] = HAL_PNL_CLK_NAME;
    u32 i;

    pstClkCfg = (HalPnlClkConfig_t *)pCfg;

    if(pstClkCfg->u32Num != HAL_PNL_CLK_NUM)
    {
        enRet = E_HAL_PNL_QUERY_RET_CFGERR;
        PNL_ERR("%s %d, Clk Num (%ld) is not match %d\n",
            __FUNCTION__, __LINE__,
            pstClkCfg->u32Num, HAL_PNL_CLK_NUM);
    }
    else
    {
        for(i=0; i<pstClkCfg->u32Num; i++)
        {
            PNL_DBG(PNL_DBG_LEVEL_CLK, "%s %d, CLK_%s: En:%d, Rate:%ld\n",
                __FUNCTION__, __LINE__,
...
{
    HalPnlClkConfig_t *pstClkCfg = NULL;
    u8 u8ClkMuxAttr[HAL_PNL_CLK_NUM] = HAL_PNL_CLK_MUX_ATTR;
    u32 u32ClkIdx;

    pstClkCfg = (HalPnlClkConfig_t *)pCfg;

    u32ClkIdx = u8ClkMuxAttr[0] ? pstClkCfg->u32Rate[0] : HalPnlClkMapMipiTxDsiToIdx(pstClkCfg->u32Rate[0]);
    HalPnlClkSetMipiTxDsi(pstClkCfg->bEn[0], u32ClkIdx);
}
...
HalPnlQueryRet_e _HalPnlIfGetInfoClkGetConfig(void *pCtx, void *pCfg)
{
    ...
    if(pstClkCfg->u32Num == HAL_PNL_CLK_NUM)
    {
        HalPnlClkGetMipiTxDsi(&pstClkCfg->bEn[0], &pstClkCfg->u32Rate[0]);

        if(u8ClkMuxAttr[0] == 0)
        {
            pstClkCfg->u32Rate[0] = HalPnlClkMapMipiTxDsiToRate(pstClkCfg->u32Rate[0]);
        }
    }
    else
    {
...
void _HalPnlIfSetUnifiedParamConfig(void *pCtx, void *pCfg)
{
    ...
    if(pstUfdParamCfg->u8TgnOutputBitMdFlag)
    {
        ...
        {
            __HalPnlIfSetPadMux(pstUfdParamCfg->eLinkType);
        }
    ...
    if(pstUfdParamCfg->u8McuPhaseFlag)
    {
        HalPnlSetMcuPhase(pstUfdParamCfg->u8McuPhase);
    }
    if(pstUfdParamCfg->u8McuPolarityFlag)
    {
        HalPnlSetMcuPolar(pstUfdParamCfg->u8McuPolarity);
    }
    if(pstUfdParamCfg->u8McuRsPolarityFlag)
    {
        HalPnlSetMcuRsPolarity(pstUfdParamCfg->u8McuRsPolarity);
    }
    //RgbDeltaMode
    ...
    if(pstUfdParamCfg->u8TgnPadMuxFlag)
    {
        PNL_DBG(PNL_DBG_LEVEL_HAL, "[HALPNL]%s %d:: LinkType:%s, PadMuxFlag:%d PadMux:%d\n",
            __FUNCTION__, __LINE__,
            PARSING_HAL_LINKTYPE(pstPnlCtxCfg->pstHalUnfdCtx->stHalPnlUdParamCfg.eLinkType),
            pstUfdParamCfg->u8TgnPadMuxFlag, pstUfdParamCfg->u16PadMux);
        switch (pstUfdParamCfg->eLinkType)
        {
            case E_HAL_PNL_LINK_TTL:
                HalPnlSetTTLPadMux(pstUfdParamCfg->u16PadMux);
                break;
            case E_HAL_PNL_LINK_BT656:
            case E_HAL_PNL_LINK_BT601:
            case E_HAL_PNL_LINK_BT1120:
                HalPnlSetBTPadMux(pstUfdParamCfg->eLinkType, pstUfdParamCfg->u16PadMux);
                break;
            case E_HAL_PNL_LINK_SRGB:
                HalPnlSetRGBPadMux(pstUfdParamCfg->eOutputFormatBitMode, pstUfdParamCfg->u16PadMux);
                break;
            case E_HAL_PNL_LINK_MCU_TYPE:
                HalPnlSetMCUPadMux(pstUfdParamCfg->stMcuInfo.enMcuDataBusCfg, pstUfdParamCfg->u16PadMux);
                break;
            default:
                break;
        }
    ...
    //mcu setting
    if(pstUfdParamCfg->u8McuConfigFlag)
    {
        HalPnlMcuCtl();
        HalPnlSetLcdRgbVActive(pstUfdParamCfg->stMcuInfo.u32VActive);
        HalPnlSetLcdRgbHActive(pstUfdParamCfg->stMcuInfo.u32HActive);
        HalPnlSetLcdRgbFramePixelCnt(pstUfdParamCfg->stMcuInfo.u32HActive*pstUfdParamCfg->stMcuInfo.u32VActive);
        HalPnlSetMcuType(pstUfdParamCfg->stMcuInfo.enMcuType);
        HalPnlMcuSetBus(pstUfdParamCfg->stMcuInfo.enMcuDataBusCfg);
        HalPnlSetMCUCycleCnt(pstUfdParamCfg->stMcuInfo.u8RSLeadCSCycleCnt,
                             pstUfdParamCfg->stMcuInfo.u8CSLeadWRCycleCnt,
                             pstUfdParamCfg->stMcuInfo.u8WRCycleCnt);
		HalPnlSetLcdRgbEn(1);					
        HalPnlSetMcuUnifiedInitCmdBuff(pstUfdParamCfg->stMcuInfo.stMcuInitCmd.pu32CmdBuf,pstUfdParamCfg->stMcuInfo.stMcuInitCmd.u32CmdBufSize);
		HalPnlSetLcdRgbEn(0);
        HalPnlSetMcuRsPolarity(!pstUfdParamCfg->u8McuRsPolarity);
        HalPnlSetMcuUnifiedAutoCmdBuff(pstUfdParamCfg->stMcuInfo.stMcuAutoCmd.pu32CmdBuf,pstUfdParamCfg->stMcuInfo.stMcuAutoCmd.u32CmdBufSize);
    }
